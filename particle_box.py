...
from WOA import WOA
from utils import get_function_details_2D
import time
...
def animate_woa(i):
    """perform animation step"""
    global woa, box, rect, dt, ax, fig
    leader_score, positions = woa.step(i)
...
ani = animation.FuncAnimation(fig, animate_woa, frames=600,
